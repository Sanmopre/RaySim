...
def _create_environment(config):
  ...
  if config.max_length:
    env = thirdParty.bullet3.examples.pybullet.gym.pybullet_envs.agents.tools.wrappers.LimitDuration(env, config.max_length)
  env = thirdParty.bullet3.examples.pybullet.gym.pybullet_envs.agents.tools.wrappers.RangeNormalize(env)
  env = thirdParty.bullet3.examples.pybullet.gym.pybullet_envs.agents.tools.wrappers.ClipAction(env)
  env = thirdParty.bullet3.examples.pybullet.gym.pybullet_envs.agents.tools.wrappers.ConvertTo32Bit(env)
  return env
